...
public class PagamentoController {
    ...
    private Comida comidaConsumida;
    ...
    public PagamentoController(PagamentoView view, Pedido pedido, Comida comida){
        this.view = view;
    ...
    public void renderizarTela() {
        int idReal = pedidoAtual.getId();
        double totalReal = comidaConsumida.getPreco();
        /*Ele aciona a view e manda eka desenhar os dados do pedido na tela*/
        view.exibirConfirmacaoDePagamento(idReal, totalReal);

        /*Logo em seguida, ele pula para o próximo metodo abaixo, para processar os dados*/
        atualizarDados(idReal, totalReal);
    }
